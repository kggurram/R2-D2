...
class AV(commands.Cog):
    ...
    #     channel = ctx.message.author.voice.channel
    #     voice1 = get(r2d2.voice_clients, guild=ctx.guild)
    ...
    #     voicenew = get(r2d2.voice_clients, guild=ctx.guild)
    ...
    #     voice2 = get(r2d2.voice_clients, guild=ctx.guild)
    ...
    #     voice3 = get(r2d2.voice_clients, guild=ctx.guild)
    #     queues.clear()
